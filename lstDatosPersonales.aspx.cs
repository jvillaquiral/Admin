...
public partial class lstDatosPersonales : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            if (!objProcesos.validarAcceso(1))
                ...
                objProcesos.registrarAuditoria("Listando datos personales", 2);
        }
    }
    protected void btnNuevo_Click(object sender, EventArgs e)
    {
        Response.Redirect("dspDatosPersonales.aspx");
    }
}
