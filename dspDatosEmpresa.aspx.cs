...
public partial class dspDatosEmpresa : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            if (!objProcesos.validarAcceso(1))
                ...
                objProcesos.registrarAuditoria("Consultando datos de la empresa", 2);
        }
    }
    protected void btnTextos_Click(object sender, EventArgs e)
    {
        Response.Redirect("dspTextosEmpresa.aspx");
    }
